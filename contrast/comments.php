...
<?php if ( have_comments() ) : ?>
	...
	<h3 id="comments"><?php comments_number('No Responses', '1 COMMENT', '% COMMENTS' ); ?></h3>
...
<div id="respond">
	...
	<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
		...
		<p><label for="username"><small>Logged in as</small></label>
		...
		<p><label for="email"><small>Mail <?php //if ($req) echo "(required)"; ?></small></label>
